...
class ObjectDetection {
    ...
    public void run(String[] args) {
        String filenameFaceCascade = args.length > 2 ? args[0] : "./haarcascade_eye_tree_eyeglasses.xml";
        String filenameEyesCascade = args.length > 2 ? args[1] : "./haarcascade_eye_tree_eyeglasses.xm";
